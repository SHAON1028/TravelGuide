...
const ServiceAllReview = ({review}) => {
    ...
    return (
        <div>
            <div className="container flex flex-col w-3/4 max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700 dark:bg-gray-900 dark:text-gray-100">
...
export default ServiceAllReview;